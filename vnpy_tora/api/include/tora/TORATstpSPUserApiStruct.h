...
namespace TORASPAPI
{
	...
	struct CTORATstpSPFensUserInfoField
	{
		...
		///版本信息
		TTORATstpSPFensVerType	FensVer;
	
		///环境编号
		TTORATstpSPFensEnvIDType	FensEnvID;
	
		///节点编号
		TTORATstpSPFensNodeIDType	FensNodeID;
	
		///Fens用户代码
		TTORATstpSPFensUserIDType	FensUserID;
	
		///用户代码
		TTORATstpSPUserIDType	UserID;
	
		///终端信息
		TTORATstpSPClientInfoType	ClientInfo;
